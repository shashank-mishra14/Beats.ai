...
export function LampComponent() {
  return (
    <LampContainer>
      ...
      >
        Music for you <br />By you
      </motion.h1>
      <Link
          href="/beatsSection"
          className="relative inline-flex h-14 overflow-hidden rounded-full p-[2px]  mt-10 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50"
        >
          <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)]" />
          <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-full bg-slate-950 px-3 py-1 text-[1.25rem] font-medium text-white backdrop-blur-3xl">
            create here
          </span>
        </Link>
    </LampContainer>
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        'relative flex min-h-[800px] pt-10 flex-col items-center justify-center overflow-hidden bg-neutral-950 w-full rounded-md z-0',
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 mt-[10rem] items-center justify-center isolate z-0 ">
        <motion.div
